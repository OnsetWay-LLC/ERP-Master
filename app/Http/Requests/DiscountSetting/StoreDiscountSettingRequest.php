...
class StoreDiscountSettingRequest extends FormRequest
{
    ...
    {
        return [
            'sub_accountant_max_discount.required' => 'Sub Accountant max discount is required.',
            ...
            'department_manager_max_discount.required' => 'Department Manager max discount is required.',
