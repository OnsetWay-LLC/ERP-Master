...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    Rule::requiredIf(function () {
        ...
        $gender = $this->input('gender', $employee?->gender);
        $maritalStatus = $this->input('marital_status', $employee?->marital_status);

        return $gender === 'male' && $maritalStatus === 'married';
    }),
    'in:working,not_working',
],

            'salary' => ['nullable', 'array'],
            'salary.salary_mode' => ['required_with:salary', 'in:bank_transfer,cash,cheques'],
            'salary.salary_value' => ['required_with:salary', 'numeric', 'min:0'],
